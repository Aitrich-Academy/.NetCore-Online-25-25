    ...
    internal class SeekerManager:IMenu
    {
                ...
                while (choice != "5")
                {
                    ...
                    switch (choice)
                    {
                        ...
                        case "2":
                            ...
                            List<Job> saved = jobManager.GetSaved(loggedUser.Id);
                            if (saved.Count == 0)
                            {
                        ...
                        case "3":
                            ...
                            List<Job> applied = jobManager.GetApplied(loggedUser.Id);
                            if (applied.Count == 0)
                            {
        ...
        public void ApplyJob()
        {
            try
            {
                ...
                jobManager.AddappliedJob(loggedUser.Id, job);
        ...
        public void SaveJob()
        {
            try
            {
                ...
                jobManager.AddSavedJob(loggedUser.Id, job);
